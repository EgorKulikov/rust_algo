//{"name":"E. Refrain","group":"Codeforces - ITMO Academy: pilot course - Suffix Array - Step 5","url":"https://codeforces.com/edu/course/2/lesson/2/5/practice/contest/269656/problem/E","interactive":false,"timeLimit":2000,"tests":[{"input":"8 3\n1 2 1 2 1 1 2 1\n","output":"9\n3\n1 2 1\n"},{"input":"1 1\n1\n","output":"1\n1\n1\n"},{"input":"6 2\n1 2 1 2 1 2\n","output":"8\n4\n1 2 1 2\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    let mut len = n;
    for i in order {
        let cand = sa.lcp(i, i + 1) * (dsu.size(i) + dsu.size(i + 1));
        if ans.maxim(cand) {
            from = sa[i];
            len = sa.lcp(i, i + 1);
        }
    ...
    out.print_line(ans);
    out.print_line(len);
    out.print_line(&s[from..from + len]);
}
