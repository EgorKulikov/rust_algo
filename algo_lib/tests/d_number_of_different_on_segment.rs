//{"name":"D. Number of Different on Segment","group":"Codeforces - ITMO Academy: pilot course - Segment Tree, part 1 - Step 4","url":"https://codeforces.com/edu/course/2/lesson/4/4/practice/contest/274684/problem/D","interactive":false,"timeLimit":4000,"tests":[{"input":"7 6\n1 2 3 6 5 4 19\n1 1 3\n1 2 5\n1 2 4\n2 2 8\n1 1 6\n1 1 3\n","output":"3\n4\n3\n6\n3\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
    ...
    for _ in 0..q {
        ...
        match t {
            1 => {
                ...
                out.print_line(st.query(x..y).0.count_ones());
            }
            2 => {
                let x = input.read_size() - 1;
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        let path = "./d_number_of_different_on_segment";
        let tl = 4000;
...
#[test]
fn d_number_of_different_on_segment() {
