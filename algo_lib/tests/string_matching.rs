//{"name":"String Matching","group":"Kattis","url":"https://open.kattis.com/problems/stringmatching","interactive":false,"timeLimit":1000,"tests":[{"input":"p\nPopup\nhelo\nHello there!\npeek a boo\nyou speek a bootiful language\nanas\nbananananaspaj\n","output":"2 4\n\n5\n7\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"StringMatching"}}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    out.print_line(t.all_matches(&s));
}
