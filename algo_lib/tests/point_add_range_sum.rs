//{"name":"Point Add Range Sum","group":"Library Checker","url":"https://judge.yosupo.jp/problem/point_add_range_sum","interactive":false,"timeLimit":5000,"tests":[{"input":"5 5\n1 2 3 4 5\n1 0 5\n1 2 4\n0 3 10\n1 0 5\n1 0 3\n","output":"15\n7\n25\n6\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"PointAddRangeSum"}}}
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        ...
        let mut paths = std::fs::read_dir("./tests/point_add_range_sum/")
            .unwrap()
            .map(|res| res.unwrap())
            .collect::<Vec<_>>();
