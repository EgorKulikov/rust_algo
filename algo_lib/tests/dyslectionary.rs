//{"name":"Dyslectionary","group":"Kattis","url":"https://open.kattis.com/problems/dyslectionary","interactive":false,"timeLimit":1000,"tests":[{"input":"apple\nbanana\ngrape\nkiwi\npear\n\nairplane\nbicycle\nboat\ncar\n","output":"banana\n apple\n grape\n  kiwi\n  pear\n\n bicycle\nairplane\n     car\n    boat\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, test_case: usize, _data: &mut PreCalc) {
    ...
    for mut s in s {
        let len = s.len();
        s.extend(std::iter::repeat(b' ').take(max_len - len));
        s.reverse();
        out.print_line(s);
    }
}
