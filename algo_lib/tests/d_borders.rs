//{"name":"D. Borders","group":"Codeforces - ITMO Academy: pilot course - Suffix Array - Step 5","url":"https://codeforces.com/edu/course/2/lesson/2/5/practice/contest/269656/problem/D","interactive":false,"timeLimit":2000,"tests":[{"input":"ababb\n","output":"20\n"},{"input":"hhya\n","output":"11\n"},{"input":"aaazaaa\n","output":"50\n"},{"input":"a\n","output":"1\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    let mut ans = 0;
    for i in order {
        ans += (sa.lcp(i, i + 1) + 1) * dsu.size(i) * dsu.size(i + 1);
        dsu.union(i, i + 1);
    }
    out.print_line(ans);
}
