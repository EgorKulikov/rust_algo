//{"name":"Polynomial Multiplication 1","group":"Kattis","url":"https://open.kattis.com/problems/polymul1","interactive":false,"timeLimit":1000,"tests":[{"input":"2\n2\n1 0 5\n1\n0 -2\n4\n1 1 -1 1 1\n4\n9 -8 7 6 5\n","output":"3\n0 -2 0 -10\n8\n9 1 -10 30 5 -2 8 11 5\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    let b = input.read_int_vec(m + 1);

    let c = convolution(&a, &b);
    out.print_line(c.len() - 1);
    out.print_line(c);
}
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        let path = "./polynomial_multiplication_1";
        let tl = 1000;
...
#[test]
fn polynomial_multiplication_1() {
