//{"name":"Static RMQ","group":"Library Checker","url":"https://judge.yosupo.jp/problem/staticrmq","interactive":false,"timeLimit":5000,"tests":[{"input":"4 10\n2 10 1 100\n0 1\n0 2\n0 3\n0 4\n1 2\n1 3\n1 4\n2 3\n2 4\n3 4\n","output":"2\n2\n1\n1\n10\n1\n1\n1\n1\n100\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"StaticRMQ"}}}
...
fn solve(input: &mut Input, _test_case: usize) {
    ...
    let mut tree = SegmentTree::from_generator(n, |i| Node(a[i]));
    for _ in 0..q {
        let l = input.read_usize();
        let r = input.read_usize();
        out_line!(tree.query(l..r).0);
    }
}
...
pub(crate) fn run_tests() -> bool {
    ...
    let mut paths = std::fs::read_dir("./tests/static_rmq/")
        .unwrap()
        .map(|res| res.unwrap())
        .collect::<Vec<_>>();
