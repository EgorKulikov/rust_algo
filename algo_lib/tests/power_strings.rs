//{"name":"Power Strings","group":"Kattis","url":"https://open.kattis.com/problems/powerstrings","interactive":false,"timeLimit":2000,"tests":[{"input":"abcd\naaaa\nababab\n.\n","output":"1\n4\n3\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    for i in 1..=s.len() {
        ...
        if hash.hash(i..) == hash.hash(..s.len() - i) {
            out.print_line(s.len() / i);
            return;
        }
    }
    unreachable!();
