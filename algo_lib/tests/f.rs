//{"name":"f","group":"Manual","url":"","interactive":false,"timeLimit":2000,"tests":[{"input":"","output":""}],"testType":"single","input":{"type":"file","fileName":"distance1.in","pattern":null},"output":{"type":"file","fileName":"distance1.out","pattern":null},"languages":{"java":{"taskClass":"f"}}}

use algo_lib::geometry::line::Line;
use algo_lib::geometry::point::Point;
use algo_lib::io::input::Input;
use algo_lib::io::output::output;
use algo_lib::numbers::num_traits::real::{Real, RealReader};
...
pub(crate) fn run_tests() -> bool {
    ...
    let mut paths = std::fs::read_dir("./tests/f/")
        .unwrap()
        .map(|res| res.unwrap())
        .collect::<Vec<_>>();
