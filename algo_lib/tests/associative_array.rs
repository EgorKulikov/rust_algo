//{"name":"Associative Array","group":"Library Checker","url":"https://judge.yosupo.jp/problem/associative_array","interactive":false,"timeLimit":5000,"tests":[{"input":"8\n0 1 2\n1 1\n1 2\n0 2 3\n1 1\n1 2\n0 2 1\n1 2\n","output":"2\n0\n2\n3\n1\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"AssociativeArray"}}}
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        ...
        let mut paths = std::fs::read_dir("./tests/associative_array/")
            .unwrap()
            .map(|res| res.unwrap())
            .collect::<Vec<_>>();
