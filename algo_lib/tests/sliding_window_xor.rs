...
//{"name":"Sliding Window Xor","group":"CSES - CSES Problem Set","url":"https://cses.fi/problemset/task/3426","interactive":false,"timeLimit":1000,"tests":[{"input":"8 5\n3 7 1 11\n","output":"0\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    let mut ans = 0;
    let mut sw = SlidingWindow::new(k, i64::bitxor);
    for _ in 0..k - 1 {
        sw.push(x);
        x = (a * x + b) % c;
    }
