//{"name":"String Multimatching","group":"Kattis","url":"https://open.kattis.com/problems/stringmultimatching","interactive":false,"timeLimit":3000,"tests":[{"input":"2\np\npup\nPopup\n2\nYou\npeek a boo\nyou speek a bootiful language\n4\nanas\nana\nan\na\nbananananaspaj\n","output":"2 4\n2\n\n5\n7\n1 3 5 7\n1 3 5 7\n1 3 5 7 9 12\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"StringMultimatching"}}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    let patterns = input.read_line_vec(n);
    ...
    let ac = AhoCorasick::<Data, 96, b' '>::new(&patterns);
    for (i, data) in ac.iterate(&s).enumerate() {
        for &j in &data.0 {
            ans[j].push(i - patterns[j].len());
        }
    }
