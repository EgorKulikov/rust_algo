//{"name":"A. Suffix Array and LCP","group":"Codeforces - ITMO Academy: pilot course - Suffix Array - Step 4","url":"https://codeforces.com/edu/course/2/lesson/2/4/practice/contest/269119/problem/A","interactive":false,"timeLimit":2000,"tests":[{"input":"ababba\n","output":"6 5 0 2 4 1 3\n0 1 2 0 2 1\n"},{"input":"aaaa\n","output":"4 3 2 1 0\n0 1 2 3\n"},{"input":"ppppplppp\n","output":"9 5 8 4 7 3 6 2 1 0\n0 0 1 1 2 2 3 3 4\n"},{"input":"nn\n","output":"2 1 0\n0 1\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
fn solve(input: &mut Input, out: &mut Output, _test_case: usize, _data: &mut PreCalc) {
    ...
    out.print_line_iter((0..=n).map(|i| sa[i]));
    out.print_line_iter((0..n).map(|i| sa.lcp(i, i + 1)));
}
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        let path = "./a_suffix_array_and_lcp";
        let tl = 2000;
