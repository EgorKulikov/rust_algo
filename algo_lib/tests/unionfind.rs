//{"name":"Unionfind","group":"Library Checker","url":"https://judge.yosupo.jp/problem/unionfind","interactive":false,"timeLimit":5000,"tests":[{"input":"4 7\n1 0 1\n0 0 1\n0 2 3\n1 0 1\n1 1 2\n0 0 2\n1 1 3\n","output":"0\n1\n0\n1\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"Unionfind"}}}
...
pub(crate) fn run_tests() -> bool {
    ...
    let mut paths = std::fs::read_dir("./tests/unionfind/")
        .unwrap()
        .map(|res| res.unwrap())
        .collect::<Vec<_>>();
