//{"name":"Polynomial Multiplication 2","group":"Kattis","url":"https://open.kattis.com/problems/polymul2","interactive":false,"timeLimit":3000,"tests":[{"input":"1\n2\n1 0 5\n1\n0 -2\n","output":"3\n0 -2 0 -10\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null}}
...
mod tester {
    ...
    pub(crate) fn run_tests() -> bool {
        let path = "./polynomial_multiplication_2";
        let tl = 3000;
...
#[test]
fn polynomial_multiplication_2() {
