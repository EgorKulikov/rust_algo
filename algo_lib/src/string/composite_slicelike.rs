...
where
    Self::Output: Sized,
{
    fn zip<'a, S2: Slicelike<Output = Self::Output>>(
        &'a self,
        s2: &'a S2,
...
impl<S: Slicelike> SlicelikeZip for S where S::Output: Sized {}

impl<'a, T, S1: Slicelike<Output = T>, S2: Slicelike<Output = T>> Index<usize>
