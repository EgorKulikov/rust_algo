...
description: Use when committing accumulated competitive-programming solutions in this repository's dated archive layout, including Kattis and Library Checker pools. Creates one commit per contest or judge pool and pushes.
---

# Commit Contests

Ported from [the Claude skill](../../../.claude/skills/commit-contests/SKILL.md).
This skill applies only to this repository. Run commands from its root.
